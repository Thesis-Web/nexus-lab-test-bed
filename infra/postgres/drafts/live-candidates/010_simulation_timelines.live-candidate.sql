...
create table if not exists simulation_timelines (
  ...
  constraint chk_simulation_timelines_status
...
create index if not exists idx_simulation_timelines_source_timeline
  on simulation_timelines (source_timeline_id);

create index if not exists idx_simulation_timelines_head_checkpoint
  on simulation_timelines (head_checkpoint_id);
